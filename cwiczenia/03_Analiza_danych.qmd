...
W tym celu wykorzystamy funkcję `pairs()`, która stowrzy macierz wykresów
...
Współczynnik korelacji liniowej Pearsona wynosi około 0,96, co świadczy o
wysokiej dodatniej korelacji. Natomiast, wartość p poniżej 0,05 sugeruje, że
...
Rycinę możemy zmodyfikować tak, aby pominąć współczynniki korelacji nieistone

...
z ogromną liczbą zmiennych (cech), które opisują pewne obserwacje (obiekty).
...
skuteczności modelu wraz ze wzrostem liczby zmiennych (słaba generalizacja
zależności).
...
reprezentację zbioru danych (wtedy najczęściej jest pomijana).

...
pozwoliłoby na wyjaśnienie ponad 90% zmienności.
...
- wartość bliska 0° wówczas są one silnie dodatnio skorelowane;
- wartość bliska 180° to parametry są silnie skorelowane, ale przeciwnie;
- wartość bliska 90° - dwa parametry są niezależne (ortogonalne).
